...
using Rimss.GraphicsProcessing.Palette.ColorCaches;
using Rimss.GraphicsProcessing.Palette.ColorCaches.Octree;
...
namespace Rimss.GraphicsProcessing.Palette.Quantizers.DistinctSelection
{
    /// <summary>
